 ...
 */
public interface RepositoryEventListenerAsync extends Remote {
     ...
     */
    public String load(String name) throws RemoteException;
     ...
     */
    public String reload(String name) throws RemoteException;
     ...
     * @throws java.rmi.RemoteException
     */
    public String unload(String name) throws RemoteException;
