 ...
 */
public class TestBasicRoutingMessage extends TestCase {
    
    public TestBasicRoutingMessage(String testName) {
        super(testName);
    }
    ...
    public void testRPCMethod() throws Exception {
        ...
        Object obj = ctx.lookup(System.getProperty("RoutingClient1"));
        ...
        routingClient.testRouting(
                System.getProperty("Routing.Target"),
                Integer.parseInt(System.getProperty("Num.Routing.Messages")));
    }
