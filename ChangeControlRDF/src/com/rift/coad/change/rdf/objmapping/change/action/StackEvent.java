...
public class StackEvent extends DataType {
    ...
    /**
     * This method returns the id of the stack event.
     *
     * @return The string containing the id of the stack.
     */
    @Override
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventComplete")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventId")
    @Identifier()
    public String getId() {
        return id;
    }
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventStart")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventStatus")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventTask")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventUsername")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#StackEventMessage")
