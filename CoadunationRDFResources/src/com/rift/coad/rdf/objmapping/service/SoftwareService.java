...
public class SoftwareService extends ResourceBase {
    ...
    /**
     * This string returns the id of the software service.
     *
     * @return The current id of the software service.
     */
    @Override
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/service#SoftwareID")
    @Identifier()
    public String getId() {
        return id;
    }
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/service#SoftwareHostname")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/service#SoftwareName")
