...
set EXTRA="'Replace with Coadunation install directory'/lib/jacorb.jar;'Replace with Coadunation install directory'/lib/log4j-1.2.13.jar;'Replace with Coadunation install directory'/lib/logkit-1.2.jar;'Replace with Coadunation install directory'/lib/CoadunationClient.jar;'Replace with Coadunation install directory'\clientlib\TimerClient.jar;'Replace with Coadunation install directory'/tools/TimerCommandLineTool.jar;'Replace with Coadunation install directory'/clientlib/avalon-framework-4.1.5.jar;"
