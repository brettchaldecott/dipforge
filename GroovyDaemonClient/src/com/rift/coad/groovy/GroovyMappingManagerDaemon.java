 ...
 *
 * GroovyMappingManagerDaemon.java
 */
 ...
 */
public interface GroovyMappingManagerDaemon extends Remote {
     ...
     */
    public List<DataMapperMethod> listMethods() throws GroovyDaemonException, RemoteException;
     ...
     * @throws java.rmi.RemoteException
     */
    public void addMethod(DataMapperMethod method) throws GroovyDaemonException, RemoteException;
     ...
     * @throws java.rmi.RemoteException
     */
    public void updateMethod(DataMapperMethod method) throws GroovyDaemonException, RemoteException;
     ...
     * @throws java.rmi.RemoteException
     */
    public void removeMethod(DataMapperMethod method) throws GroovyDaemonException, RemoteException;
