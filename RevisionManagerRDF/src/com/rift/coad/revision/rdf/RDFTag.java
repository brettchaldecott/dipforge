...
public class RDFTag extends DataType {
    ...
    /**
     * The object that contains the tag information.
     *
     * @return The string containing the tag information
     */
    @Override
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/revision#TagAuthor")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/revision#TagCreated")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/revision#TagDescription")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/revision#TagName")
