...
public class RDFScriptInfo extends DataType {
    ...
    /**
     * This method returns the object id for the RDF script information.
     *
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/script#ScriptFileName")
    @Identifier()
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/script#ScriptScope")
    @Identifier()
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/script#ScriptFileType")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/script#ScriptFileLastModified")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/script#ScriptFileVersion")
