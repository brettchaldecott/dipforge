...
import com.rift.coad.script.client.files.php.PHPFileManagerConnector;
 ...
 */
public class PHPScopeCache implements AsyncCallback {

    // class singleton methods
    private static PHPScopeCache singleton = null;
     ...
     */
    private PHPScopeCache() {
        PHPFileManagerConnector.getService().listScopes(this);
    }
     ...
     */
    public static synchronized PHPScopeCache getInstance() {
        if (singleton == null) {
            singleton = new PHPScopeCache();
        }
        return singleton;
    }
