 ...
 */
public class GroovyTemplateException extends Exception {

    /**
     * Creates a new instance of <code>TemplateException</code> without detail message.
     */
    public GroovyTemplateException() {
    }
     ...
     */
    public GroovyTemplateException(String msg) {
        super(msg);
    }
     ...
     */
    public GroovyTemplateException(String msg, Throwable cause) {
        super(msg,cause);
    }
}
