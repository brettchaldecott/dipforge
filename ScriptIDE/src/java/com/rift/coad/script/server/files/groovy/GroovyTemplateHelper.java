 ...
 */
public class GroovyTemplateHelper {
     ...
     * @param path The path.
     */
    public GroovyTemplateHelper(String path) throws GroovyTemplateException {
        this.path = new File(path);
        if (!this.path.exists()) {
            throw new GroovyTemplateException("The template [" + path +
                    "] does not exist.");
     ...
     */
    public String parse() throws GroovyTemplateException {
        try {
            ...
            throw new GroovyTemplateException("Failed to parse the template [" +
