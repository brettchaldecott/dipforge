 ...
 */
public class PHPTemplateException extends Exception {

    /**
     * Creates a new instance of <code>TemplateException</code> without detail message.
     */
    public PHPTemplateException() {
    }
     ...
     */
    public PHPTemplateException(String msg) {
        super(msg);
    }
     ...
     */
    public PHPTemplateException(String msg, Throwable cause) {
        super(msg,cause);
    }
}
