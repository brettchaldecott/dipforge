...
<html>
    <head>
        ...
        <script language="Javascript" type="text/javascript">
            editAreaLoader.init({
                id: "phpeditor_${number}"	// id of the textarea to transform
            ...
            function my_save(id, content){
                ...
                var url = '/ScriptIDE/PHPFileEditor?action=save';
    ...
    <body>
        <form action='' method='post' id="textareaHolder">
            <textarea id="phpeditor_${number}" style="height:100%; width:100%;" name="phpeditor_area${number}">${fileContents}</textarea>
