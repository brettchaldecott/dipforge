 ...
 * @author brett
 */
public class RDFTypeHelperTest extends TestCase {
    
    public RDFTypeHelperTest(String testName) {
        super(testName);
    }
    ...
    /**
     * Test of getRdfType method, of class RDFTypeHelper.
     */
    public void testGetRdfType() throws Exception {
        System.out.println("getRdfType");
        RDFTypeHelper instance = new RDFTypeHelper(TestClass.class);
