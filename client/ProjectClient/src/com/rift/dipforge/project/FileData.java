...
public class FileData implements Serializable {
     ...
     */
    public FileData(String name, String path, int type, Date created, 
            String creator, Date modified, String modifier, String hash, String contents) {
        this.name = name;
        this.path = path;
    ...
    public String toString() {
        return "FileData{" + "name=" + name + "path=" + path + "type=" + type
