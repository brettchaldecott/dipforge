 ...
 */
public interface MasterRDFStoreDaemonAsync extends Remote {
     ...
     */
    public String persist(String action, String rdfXML) throws 
            MasterRDFStoreException, RemoteException;
}
