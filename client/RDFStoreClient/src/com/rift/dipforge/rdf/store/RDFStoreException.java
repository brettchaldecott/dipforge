...
public class RDFStoreException extends Exception implements Serializable {
    ...
    /**
     * Constructs an instance of <code>RDFStoreException</code> with the specified detail message.
     ...
     * @param msg the detail message.
     */
    public RDFStoreException(String msg,Throwable ex) {
        super(msg,ex);
    }
}
