 ...
 */
public class RoboticsDaemonException extends Exception implements java.io.Serializable {
     ...
     */
    public RoboticsDaemonException() {
    }
     ...
     */
    public RoboticsDaemonException(String msg) {
        super(msg);
    }
     ...
     */
    public RoboticsDaemonException(String msg, Throwable ex) {
        super(msg,ex);
    }
     ...
     * @param ex The cause of this exception.
     */
    public RoboticsDaemonException(String msg, String stringStack) {
        super(msg);
