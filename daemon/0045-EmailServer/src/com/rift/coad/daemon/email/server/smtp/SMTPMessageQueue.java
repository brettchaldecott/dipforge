 ...
 */
public class SMTPMessageQueue implements XAResource {
    ...
    public class ChangeEntry {
        // member variables
        private SMTPServerMessage value = null;
         ...
         */
        public ChangeEntry(SMTPServerMessage value, byte changeType) {
            this.value = value;
         ...
         */
        public SMTPServerMessage getValue() {
            return value;
        }
    ...
    public class Changes {
         ...
         */
        public void addEntry(SMTPServerMessage value) {
         ...
         * @exception BeanException
         */
        public void addPopEntry(SMTPServerMessage value) {
    ...
    private final static String RETRY_TIME = "email_retry_time";
    private final static long DEFAULT_RETRY_TIME = 1000 * 60 * 10;
    
    
    // private member variables.
    private Logger log = Logger.getLogger(SMTPMessageQueue.class);
     ...
     */
    public SMTPMessageQueue() throws SMTPException {
        try {
            Configuration config = ConfigurationFactory.
                    getInstance().getConfig(SMTPMessageQueue.class);
     ...
     */
    public void add(SMTPServerMessage value) throws SMTPException{
        try {
     ...
     * @param SMTPException
     */
    public SMTPServerMessage pop(UserTransactionWrapper transaction) 
    throws SMTPException {
        try {
            while (!state.isTerminated()) {
                ...
                SMTPServerMessage message = (SMTPServerMessage)queue.peek();
                long retryTime = message.getRetryDate().getTime() + 
                        this.retryTime;
     ...
     * This method addes this entry to the queue.
     */
    public void clear() throws SMTPException{
        try {
            TransactionManager.getInstance().bindResource(this,false);
            Changes changes = (Changes)transactionChanges.get(
                    currentTransaction.get());
     ...
     */
    private void getLock(Object name) throws SMTPException {
        try {
            Object key = null;
