...
public class LogEvent {
    ...
    private LogEvent() {
        try {
            ...
            role = config.getString(RSS_MANAGER_ROLE,RSS_MANAGER_ROLE_DEFAULT);
        } catch (Exception ex) {
     ...
     */
    public void logEvent(String name, String externalId, String username, String application, String description, String url) {
        try {
            FeedManagerAsync feedManager = (FeedManagerAsync)RPCMessageClient.createOneWay(
                    "rss/Management", FeedManager.class, FeedManagerAsync.class, feedJNDI);
