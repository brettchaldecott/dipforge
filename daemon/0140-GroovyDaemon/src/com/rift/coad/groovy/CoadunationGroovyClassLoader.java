 ...
 */
public class CoadunationGroovyClassLoader extends URLClassLoader {
     ...
     * @param urls URLS.
     */
    public CoadunationGroovyClassLoader(URL[] urls) {
        super(urls);
     ...
     * @param parent
     */
    public CoadunationGroovyClassLoader(URL[] urls, ClassLoader parent) {
        super(urls, parent);
