...
/**
 * This object manages the JNDI stack information.
 * @author brett chaldecott
 */
public class LsJNDIStackEntry extends ProcessStackEntry {

    
    // private member variables
    private CallStatement callStatement;
    private JNDIRPCCall call;
    ...
    public void execute() throws EngineException {
        try {
            if (!this.executed) {
                ...
                List<MethodMapping> methods = daemon.listMethods(this.call.getJndi(), 
                ...
                for (MethodMapping method : methods) {
                    ...
                    DataMapperAsync dataMapperBroker = (DataMapperAsync)RPCMessageClient.create(
                            ...
                            DataMapperAsync.class, this.call.getJndi(),
                ...
                throw new EngineException("No method found matching the "
                        + "configuration [" + this.call.getJndi() + "][" +
                        this.call.getProject() + "][" + this.call.getClassName() 
