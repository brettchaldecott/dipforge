...
/**
 * This object is responsible for implementing the broad cast server interface.
 *
 * @author Brett Chaldecott
 */
public class BroadcastServerImpl1 implements BroadcastServer {
    
    /** 
     * Creates a new instance of BroadcastServerImpl1 
     */
    public BroadcastServerImpl1() throws BroadcastException {
        try {
            ...
            services.add("test2");
            serviceBroker.registerService("messagetest/BroadcastServer1",
                    services);
        } catch (Exception ex) {
    ...
    public String testMethod(String message) throws RemoteException {
        System.out.println("[BroadcastServerImpl1]Message is : " + message);
        return "[BroadcastServerImpl1]" + new Date().getTime();
    }
}
