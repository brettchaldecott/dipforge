 ...
 */
public class NamedServer1Impl implements NamedServer1, BeanRunnable {
    
    // the logger reference
    protected Logger log =
            Logger.getLogger(NamedServer1Impl.class.getName());
    ...
    public void process() {
        ...
        while(!state.isTerminated()) {
            try {
                ...
                log.info("Text value is : " + textMessage.getTextBody());
                NamedSingleton.getInstance().incrementCount();
            } catch (Exception ex) {
