 ...
 */
public interface RPCClient2Async extends Remote {
     ...
     */
    public String runOneWayTest(int numMessages) throws RemoteException,
            MessageTestException;
    
    
    /**
     * This method is called by the test object.
     *
     * @param message The message value.
     * @exception RemoteException
     */
    public String onewayMethod(String message) throws RemoteException;
}
