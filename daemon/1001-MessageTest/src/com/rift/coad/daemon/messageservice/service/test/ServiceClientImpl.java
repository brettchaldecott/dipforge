...
/**
 * This object implements the service client interface.
 *
...
public class ServiceClientImpl implements ServiceClient {
    ...
    /** 
     * Creates a new instance of ServiceClientImpl 
     */
     ...
     */
    public void runTest(int num) throws ServiceException {
        System.out.println("The runtime class");
        try {
            List services = new ArrayList();
            services.add("test");
            ServiceServerAsync async1 = (ServiceServerAsync)
                    RPCMessageClient.create(
                    ServiceClient.JNDI_URL,ServiceServer.class,
                    ServiceServerAsync.class,services,false);
            
            results = 0;
            for (int count = 0; count < num; count++) {
                System.out.println("Make call");
                async1.callMethod("Bob");
            }
