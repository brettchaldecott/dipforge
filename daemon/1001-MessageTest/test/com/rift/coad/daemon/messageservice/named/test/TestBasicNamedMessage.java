 ...
 */
public class TestBasicNamedMessage extends TestCase {
    
    public TestBasicNamedMessage(String testName) {
        super(testName);
    }
    ...
    public void testRPCMethod() throws Exception {
        ...
        Object obj = ctx.lookup(System.getProperty("NamedClient1"));
        System.out.println(obj.getClass().getName());
        NamedClient1 namedClient1 = null;
        try {
             namedClient1 = (NamedClient1)
        ...
        namedClient1.runBasicTest(Integer.parseInt(
                System.getProperty("Num.Named.Messages")));
    }
