 ...
 */
public class TestBasicRPCMessage extends TestCase {
    
    public TestBasicRPCMessage(String testName) {
        super(testName);
    }
    ...
    public void testRPCMethod() throws Exception {
        ...
        Object obj = ctx.lookup(System.getProperty("RPCClient1"));
        System.out.println(obj.getClass().getName());
        RPCClient1 rpcClient1 = null;
        try {
        ...
        rpcClient1.runBasicTest(Integer.parseInt(
