...
/**
 * This class is responsible for testing the transaction RMI cache.
 * @author Brett Chaldecott
 */
public class TransactionRMICacheTest extends TestCase {
    ...
    public TransactionRMICacheTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(TransactionRMICacheTest.class);
    ...
    public void testRMICache() throws Exception {
        ...
        TransactionRMICache instance = new TransactionRMICache();
        
        
        RMICacheTestClass cacheObject1 = new RMICacheTestClass();
        RMICacheTestClass cacheObject2 = new RMICacheTestClass();
        RMICacheTestClass cacheObject3 = new RMICacheTestClass();
        RMICacheTestClass cacheObject4 = new RMICacheTestClass();
        
        ut.begin();
        instance.addCacheEntry(500,cacheObject3);
        ut.rollback();
        ...
        ut.begin();
        instance.addCacheEntry(500,cacheObject4);
        ut.commit();
        
        if (!instance.contains(cacheObject1)) {
            fail("Cache does not contain entry1");
        }
        if (!instance.contains(cacheObject2)) {
            fail("Cache does not contain entry2");
        }
