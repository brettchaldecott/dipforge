...
I very rarely use them and an if statement can be used the same way.
I need a decent reason for putting it into the language.
...
callStatement returns [CallStatement value]
  ...
  })* (lsArg1=listArgument {currentEntry.setArgument(lsArg1);} | paramArg1=parameterArgument {currentEntry.setArgument(paramArg1);}) ?;
