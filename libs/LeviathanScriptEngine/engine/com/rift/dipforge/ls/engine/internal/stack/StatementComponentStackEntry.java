...
/**
 * The statement component stack entry.
 * 
 * @author brett chaldecott
 */
public abstract class StatementComponentStackEntry extends StatementStackEntry {

    
    /**
     * This constructor sets up the statement component stack entry.
     * 
     * @param processorMemoryManager The process memory manager.
     * @param parent The parent.
     */
    public StatementComponentStackEntry(
