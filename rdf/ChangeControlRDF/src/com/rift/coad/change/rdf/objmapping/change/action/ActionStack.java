...
public class ActionStack extends DataType {
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackAction")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackId")
    @Identifier()
    public String getId() {
        return id;
    }
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackMasterRequestId")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackRequestId")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackStack")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ActionStackEvents")
