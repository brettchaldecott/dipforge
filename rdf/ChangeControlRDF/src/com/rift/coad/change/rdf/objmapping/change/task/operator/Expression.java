...
import com.rift.coad.change.rdf.objmapping.change.task.logic.*;
...
public class Expression extends DataType {
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ExpressionList")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/change#ExpressionId")
    public String getId() {
        return id;
    }
