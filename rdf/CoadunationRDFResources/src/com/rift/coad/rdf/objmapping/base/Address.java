...
public class Address extends DataType {
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/base#AddressId")
    @Identifier()
    public String getId() {
        return id;
    }
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/base#AddressValue")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/base#AddressCodeRef")
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/base#CountryRef")
