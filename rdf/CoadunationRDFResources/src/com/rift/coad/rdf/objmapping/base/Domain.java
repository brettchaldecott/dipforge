...
public class Domain extends DataType {
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/base#DomainValue")
    @Identifier()
    ...
    /**
     * This method returns the object id for this entry.
     * 
    ...
    private void validate(String value) throws ObjException {
        if (value != null && (!value.equals("")) && !(value.matches("[a-zA-Z0-9.-]+"))) {
            throw new ObjException("The value is not a correctly formated domain name [" + value + "]");
        }
    }
