 ...
 */
@Namespace("http://www.coadunation.net/schema/rdf/1.0/organisation#")
...
public class Organisation extends ResourceBase {
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/organisation#Id")
    @Identifier()
    public String getId() {
        return id;
    }
     ...
     */
    @RdfProperty("http://www.coadunation.net/schema/rdf/1.0/organisation#Name")
