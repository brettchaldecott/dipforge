...
public class BeanCopy {
    ...
    public static <T> T copy(Class<T> type, Object value) throws UtilException {
     ...
     */
    public static <T> T copy(Class<T> type, Object value, boolean deepCopy) throws UtilException {
        try {
     ...
     * @throws com.rift.coad.rdf.objmapping.util.UtilException
     */
    public static <T> T[] copyToArray(Class<T> type, Object internalArray) throws UtilException {
        try {
