...
<head>
    <meta charset="utf-8">
    <title>Dipforge Datacenter | Version 4.1.a25</title>
...
<body>
    <div class="container">
        <div class="masthead">
            <h3 class="muted"><a href="."><image height="30px" width="30px" src="images/dipForgeLogo_small.png"/></a>&nbsp;dipforge&nbsp;datacenter&nbsp;4.1.a25
