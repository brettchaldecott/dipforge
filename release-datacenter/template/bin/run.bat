...
echo %JAVA% %JAVA_OPTS% -Xmx2048M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/DipforgeDatacenterBase.jar"
%JAVA% %JAVA_OPTS% -Xmx2048M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/DipforgeDatacenterBase-%VERSION%.jar"
