...
export EXTRA="${DIPFORGE_HOME}/lib/jacorb.jar:${DIPFORGE_HOME}/lib/log4j-1.2.13.jar:${DIPFORGE_HOME}/lib/logkit-1.2.jar:${DIPFORGE_HOME}/lib/CoadunationClient.jar:${DIPFORGE_HOME}/clientlib/JythonDaemonClient.jar:${DIPFORGE_HOME}/tools/JythonDaemonCommandLineTool.jar:${DIPFORGE_HOME}/clientlib/avalon-framework-4.1.5.jar:"
