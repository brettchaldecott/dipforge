<!--
Date: Fri Jan 04 05:43:08 SAST 2013
File: finish.gsp
...
<html lang="en">
  ...
  <body>
    ...
    <% PageManager.includeWithResult("SideBar.groovy", request, response, ["menuItem" : "finish"]) %>
    
    <% PageManager.includeWithResult("shopping/Finish.groovy", request, response, [:]) %>
    
    <% PageManager.includeWithResult("Footer.groovy", request, response, ["menuItem" : "finish"]) %>
