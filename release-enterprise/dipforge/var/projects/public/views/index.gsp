...
<head>
    <meta charset="utf-8">
    <title>Dipforge Enterprise | Version 4.1.a25</title>
...
<body>
    <div class="container">
        <div class="masthead">
            <h3 class="muted"><a href="."><image height="30px" width="30px" src="images/dipForgeLogo_small.png"/></a>&nbsp;dipforge&nbsp;enterprise&nbsp;4.1.a25
