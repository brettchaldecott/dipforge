...
echo %JAVA% %JAVA_OPTS% -Xmx2048M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/DipforgeEnterpriseBase.jar"
%JAVA% %JAVA_OPTS% -Xmx2048M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/DipforgeEnterpriseBase-%VERSION%.jar"
