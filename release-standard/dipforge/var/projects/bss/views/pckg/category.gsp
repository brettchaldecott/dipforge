...
<html lang="en">
  ...
  <body>
    ...
    <% PageManager.includeWithResult("SideBar.groovy", request, response, ["menuItem" : "category","contextBase":"../"]) %>
    
    <% PageManager.includeWithResult("category/List.groovy", request, response, ["contextBase":"../"]) %>
