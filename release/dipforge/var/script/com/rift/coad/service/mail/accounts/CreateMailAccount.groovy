/*
 * Mon Feb 22 10:06:32 SAST 2010
 * CreateMailAccount.groovy
 * @author admin
 */
...
try {
    ...
    if (!found) {
        ...
        daemon.createMailBox(domainName,MailAccount.getName(),
            MailAccount.getAttribute(com.rift.coad.rdf.objmapping.base.password.ClearTextPassword,"password").getValue(),0)
