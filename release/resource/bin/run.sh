...
# run
echo $JAVA $JAVA_OPTS -Xmx256M -XX:PermSize=128M -XX:MaxPermSize=256M -jar $DIPFORGE_HOME/sbin/CoadunationBase-$VERSION.jar
$JAVA $JAVA_OPTS -Xmx256M -XX:PermSize=128M -XX:MaxPermSize=256M -jar $DIPFORGE_HOME/sbin/CoadunationBase-$VERSION.jar
