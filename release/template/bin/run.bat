...
echo %JAVA% %JAVA_OPTS% -Xmx2048M -XX:PermSize=128M -XX:MaxPermSize=256M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/CoadunationBase.jar"
%JAVA% %JAVA_OPTS% -Xmx2048M -XX:PermSize=128M -XX:MaxPermSize=256M -cp %EXTRA% -jar "%DIPFORGE_HOME%/sbin/CoadunationBase-%VERSION%.jar"
