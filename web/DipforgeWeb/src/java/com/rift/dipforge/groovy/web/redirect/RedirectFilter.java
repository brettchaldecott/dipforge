...
package com.rift.dipforge.groovy.web.redirect;
...
public class RedirectFilter implements Filter {
    ...
    private static String DEFAULT_WELCOME_FILE = "index.gsp";
    ...
    /**
     * Default redirect filter constructor
     */
    public RedirectFilter() {
    } 

    /**
     * The do before process if something required.
     * @param request
     * @param response
     * @throws IOException
	...
	if (debug) log("RedirectFilter:DoBeforeProcessing");

    } 

    /**
     * Post request request processing if required.
     *
     * @param request
     * @param response
     * @throws IOException
	...
	throws IOException, ServletException {
	if (debug) log("RedirectFilter:DoAfterProcessing");
	...
	if (debug) log("RedirectFilter:doFilter()");
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("RedirectFilter: Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("RedirectFilter()");
	...
	public void setParameter(String name, String []values) {
	    if (debug) System.out.println("RedirectFilter::setParameter(" + name + "=" + values + ")" + " localParams = "+ localParams);
	...
	public String getParameter(String name) {
	    if (debug) System.out.println("RedirectFilter::getParameter(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public String[] getParameterValues(String name) {
	    if (debug) System.out.println("RedirectFilter::getParameterValues(" + name + ") localParams = " + localParams);
	    if (localParams == null)
	...
	public Enumeration getParameterNames() {
	    if (debug) System.out.println("RedirectFilter::getParameterNames() localParams = " + localParams);
	    if (localParams == null)
	...
	public Map getParameterMap() {
	    if (debug) System.out.println("RedirectFilter::getParameterMap() localParams = " + localParams);
	    if (localParams == null)
