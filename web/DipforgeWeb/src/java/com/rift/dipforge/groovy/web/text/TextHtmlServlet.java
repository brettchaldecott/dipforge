...
package com.rift.dipforge.groovy.web.text;
...
public class TextHtmlServlet extends HttpServlet {
    ...
    private static Logger log = Logger.getLogger(TextHtmlServlet.class);
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            Configuration configuration = ConfigurationFactory.getInstance().getConfig(
                    TextHtmlServlet.class);
            dipforgeLibDir = configuration.getString(
                    TextHtmlConstants.DIPFORGE_LIB_DIR);
            baseDir = configuration.getString(
                    TextHtmlConstants.ENVIRONMENT_BASE);
            webDir = configuration.getString(
                    TextHtmlConstants.WEB_DIRECTORY);
