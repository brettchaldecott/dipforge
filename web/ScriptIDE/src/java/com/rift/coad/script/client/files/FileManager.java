...
/**
 * This interface represents the file manager functionality.
 *
 * @author brett chaldecott
 */
public interface FileManager extends RemoteService{
    ...
    /**
     * This method is called to execute the file.
     *
     * @param scope The name space of the file.
     * @param name The name of the file.
     * @throws com.rift.coad.script.client.files.FileManagerException
     */
    public String executeFile(String scope, String name)
            throws FileManagerException;
