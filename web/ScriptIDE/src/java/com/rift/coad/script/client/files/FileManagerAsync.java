...
/**
 * This asynchronous interface for the file manager.
 *
 * @author brett chaldecott
 */
public interface FileManagerAsync {
    ...
    /**
     * This method executes the specified file and returns the result.
     *
     * @param scope The string containing the scope.
     * @param name The name of the file to execute.
     * @param callback The object that the result will be passed to.
     */
    public void executeFile(String scope, String name,
            AsyncCallback callback);
}
