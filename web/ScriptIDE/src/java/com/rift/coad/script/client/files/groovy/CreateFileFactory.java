...
public class CreateFileFactory {
    ...
    public class CreateFilePanel extends VLayout {
        ...
        public CreateFilePanel() {
            ...
            scope.setWidth("*");
            scope.setValueMap(GroovyScopeCache.getInstance().getScopes().toArray(new String[0]));
        ...
        private void handleCreate() {
            try {
                ...
                GroovyFileManagerConnector.getService().createFile(fileTypeName, fileScopeName, fileName,
                        new FileCreateCallbackHandler(callback, fileTypeName, fileScopeName, fileName));
            } catch (Exception ex) {
     ...
     */
    public CreateFileFactory( NavigationDataCallback callback) {
