 ...
 */
public class GroovyViewSourceCache implements AsyncCallback {

    // class singleton
    private static GroovyViewSourceCache singleton = null;
     ...
     */
    private GroovyViewSourceCache() {
        GroovyViewSourceManagerConnector.getService().getWebPath(this);
    }
     ...
     */
    public synchronized static GroovyViewSourceCache getInstance() {
        if (singleton == null) {
            singleton = new GroovyViewSourceCache();
        }
        return singleton;
    }
