...
public class CreateFileFactory {
    ...
    public class CreateFilePanel extends VLayout {
        ...
        public CreateFilePanel() {
            ...
            scope.setWidth("*");
            scope.setValueMap(PHPScopeCache.getInstance().getScopes().toArray(new String[0]));
        ...
        private void handleCreate() {
            try {
                ...
                PHPFileManagerConnector.getService().createFile(fileTypeName, fileScopeName, fileName,
