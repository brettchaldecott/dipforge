 ...
 */
public class PHPTemplateHelper {
     ...
     * @param path The path.
     */
    public PHPTemplateHelper(String path) throws PHPTemplateException {
        this.path = new File(path);
        if (!this.path.exists()) {
            throw new PHPTemplateException("The template [" + path +
                    "] does not exist.");
     ...
     */
    public String parse() throws PHPTemplateException {
        try {
            ...
            throw new PHPTemplateException("Failed to parse the template [" +
