...
<html>
    <head>
        ...
        <script language="Javascript" type="text/javascript">
            editAreaLoader.init({
                id: "groovyeditor_${number}"	// id of the textarea to transform
            ...
            function my_save(id, content){
                ...
                var url = '/ScriptIDE/GroovyFileEditor?action=save';
    ...
    <body>
        <form action='' method='post' id="textareaHolder">
            <textarea id="groovyeditor_${number}" style="height:100%; width:100%;" name="groovyeditor_area${number}">${fileContents}</textarea>
