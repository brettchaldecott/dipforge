...
public class ActionInfo extends DataType {
     ...
     * The default constructor.
     */
    public static ActionInfo createInstance() {
        ActionInfo info = new ActionInfo();
        info.setIdForDataType(Constants.ACTION_INFO);
        info.setBasicType(Constants.ACTION_INFO);
        return info;
    }
     ...
     * @param description The description.
     */
    public static ActionInfo createInstance(String name, String description) {
        ActionInfo info = createInstance();
        info.setName(name);
